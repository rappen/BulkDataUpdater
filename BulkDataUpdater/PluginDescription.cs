namespace Cinteros.XTB.BulkDataUpdater
{
    ...
    ExportMetadata("Description", "Work with any number of rows in Microsoft Dataverse! Update Column values / Assign / Set State / Delete. Empower yourself to achieve more."),
